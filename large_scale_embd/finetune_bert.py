...
parser.add_argument('--dataset', default='R52', choices=['20ng', 'R8', 'R52', 'ohsumed', 'mr','SST-2','Airline-Sentiment','SST-1'])                         
...
# Data Preprocess
all_x,all_y,x, y, adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, train_size, test_size = load_corpus(dataset, path)
'''
y_train, y_val, y_test: n*c matrices     
train_mask, val_mask, test_mask: n-d bool array
train_size, test_size: unused
'''
print('y_train.shape: ',y_train.shape, 'y_val: ', y_val.shape )
...
corpus_file = path+'/data_for_transd_Learn/SeqGR/corpus/'+dataset+'_shuffle.txt'
