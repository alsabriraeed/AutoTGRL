...
def load_data(dataset_str, path ):      
    ...
    for i in range(len(names)):
        with open(path+ "/data_for_transd_Learn/SeqGR/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file(
        path+ "/data_for_transd_Learn/SeqGR/ind.{}.test.index".format(dataset_str))      
...
def load_corpus(dataset_str, path):
    """
...
#  features combine the training and test x
    ...
    train_idx_orig = parse_index_file(
        path+ "/data_for_transd_Learn/SeqGR/{}.train.index".format(dataset_str))
