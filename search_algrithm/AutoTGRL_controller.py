...
class SimpleNASController(torch.nn.Module):
    ...
    def __init__(self, args, search_space, action_list, controller_hid=100, cuda=True, mode="train",
        ...
        # this is to check the actions in the action_list in the serach space
        ...
        # num_tokens number of action types potentianal for each action
        # num_total_tokens: totoal number of action type
    ...
    def forward(self,
                ...
                action_name,
                is_embed):
        # why inputs and hidden are zeroes
        embed = inputs
    ...
    def sample(self, batch_size=1, with_details=False):
        ...
        # for each action the model  is running        
