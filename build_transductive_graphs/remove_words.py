...
def clean_text(dataset, path):
    ...
    doc_content_list = []
    f = open(path+'/data_for_transd_Learn/SeqGR/corpus/' + dataset + '.txt', 'rb')
    ...
    f = open(path+'/data_for_transd_Learn/SeqGR/corpus/' + dataset + '.clean.txt', 'w')
